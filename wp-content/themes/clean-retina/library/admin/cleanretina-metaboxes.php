...
$sidebar_layout = array(
							'default-sidebar' 		=> array(
															...
															'value' 		=> 'default',
															'label' 		=> __( 'Default Layout Set in', 'cleanretina' ).' '.'<a href="'.wp_customize_url() .'?autofocus[section]=cleanretina_default_layout" target="_blank">'.__( 'Customizer', 'cleanretina' ).'</a>',
															'thumbnail' => ' '
															),
							'no-sidebar' 				=> array(
															'id'			=> 'cleanretina_sidebarlayout',
